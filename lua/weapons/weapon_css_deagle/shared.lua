...
SWEP.SoundData				=
{
	...
	single_shot				= "addons/css/deagleshoot.mp3"
}
...
function SWEP:PrimaryAttack()
	...
	local spread 		= random.RandomFloat( 0.01745 , 0.06976 )

	-- vecSrc - position of fire, vecAiming - Directory where is shooting, bullet spread, distance, Ammo Type
	local info = FireBulletsInfo_t(1, vecSrc, vecAiming, Vector(spread) ,8096, self.m_iPrimaryAmmoType);
	info.m_flDamage = 28;
