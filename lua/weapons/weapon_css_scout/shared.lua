...
SWEP.printname				= "Scout CSS"
SWEP.viewmodel 			  = "models/weapons/v_snip_scout.mdl"
SWEP.viewmodelfov     =  65
SWEP.playermodel			= "models/weapons/w_snip_scout.mdl"
...
SWEP.SoundData				=
{
	...
	single_shot				= "addons/weapons/scout/scout_fire-1.wav"
}
...
function SWEP:PrimaryAttack()
	...
	self.m_flNextPrimaryAttack = gpGlobals.curtime() + 1.10;
