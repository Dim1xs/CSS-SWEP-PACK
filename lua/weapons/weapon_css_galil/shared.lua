...
SWEP.printname				= "Galil CSS"
SWEP.viewmodel 			    = "models/weapons/v_rif_galil.mdl"
SWEP.viewmodelfov           =  65
SWEP.playermodel			= "models/weapons/w_rif_galil.mdl"
SWEP.anim_prefix			= "python"
SWEP.bucket					= 2
SWEP.bucket_position		= 6

SWEP.clip_size				= 35
SWEP.clip2_size				= -1
SWEP.default_clip			= 35
...
SWEP.SoundData				=
{
	...
	single_shot				= "addons/css/galil-1.mp3"
}
